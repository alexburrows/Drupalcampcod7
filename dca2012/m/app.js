(function($) {
  ...
  var sponsors_url = 'http://2012.drupalcampasheville.com/rest/views/sponsors.json';
  $.getJSON(sponsors_url, function(data) {
    $.each(data, function(index, value){
      $('#page5 [data-role="content"]').append(value.nid+"<br/>"+value.node_title);
    });
  });
